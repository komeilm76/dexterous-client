    ...
    .record(
      ...
      z.object({
        ...
        entryTask: z.function({
          input: [
            z.object({
              turnOnLoading: z.function(),
              turnOffLoading: z.function(),
            }),
          ],
        }),
      }),
...
const recheck = new Subject<
  | { eventType: "please_add_to_list"; data: ReturnType<typeof makeToast> }
  | { eventType: "please_show"; data: ReturnType<typeof makeToast> }
  | { eventType: "please_retry_show" }
  | { eventType: "please_hide"; data: ReturnType<typeof makeToast> }
  | { eventType: "please_save"; data: ReturnType<typeof makeToast> }
>();
