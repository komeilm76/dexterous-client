...
export default () => {
  return tools.controller.makeMiddleware<IConfig>((config, next) => {
    // log
    const { log } = tools.logger.instance("[micro-service/head/task-1]($)");
    // -----------------------------------------
    // file name
    ...
    const startLabel = "<!-- micro/head/start  (Generated by micro-service/head. ‼️ DO NOT MODIFY THIS FILE ‼️) -->";
